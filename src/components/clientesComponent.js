...
import '../index.css';
import {crearCliente} from "../apis/Clientes"
    ...
    return(
        <Row className="justify-content-md-center" style={{margin:"5%"}}>
                ...
                <Modal.Body>
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3" controlId="exampleForm.ControlDatearea">
                            ...
                            <Form.Control required type="date" placeholder="Fecha" onChange={e=>setFechaNacimiento(e.target.value)}/>
                            <Form.Control.Feedback type="invalid">Ingrese el Telefono.</Form.Control.Feedback>
                        </Form.Group> 
                    </Form>
                </Modal.Body>
            ...
            <Alert show={show3} variant="success" onClose={() => {setShow3(false);setError("");setValidated(false)}} dismissible>
                <Alert.Heading>Cliente Creado</Alert.Heading>
                <p>
                Cliente Creado Exitosamente
                </p>
            </Alert>
            <button type="button" onClick={handleShow} style={{margin:"2%",width:"40%"}} className="btn btn-dark">Crear Cliente</button>
