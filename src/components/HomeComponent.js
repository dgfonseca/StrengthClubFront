...
export default function HomePane(props){
    ...
    const handleCloseVenta = () => {setPaquetesSeleccionados([]);setProductosSeleccionados([]);setCliente(null);setPaqueteSeleccionado(null);setProductoSeleccionado(null);setShowVenta(false);setPrecioCalculado(0);setProductoCarritoSeleccionado(null);setPaqueteCarritoSeleccionado(null);setFecha(null);setHora(null);setCantidadPaquete(0);setCantidad(0)};
    ...
    function agregarPaquete(){
        ...
        setPrecioCalculado(precioCalculado+(paqueteSeleccionado.precio*cantidadPaquete))
    }
