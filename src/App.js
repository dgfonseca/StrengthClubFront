...
function App() {
  ...
  return (
    <Router>
      <div className="App" style={{ backgroundImage: `url("/strength.png")`, backgroundRepeat: "no-repeat", backgroundPositionY: "60%", backgroundPositionX: "50%", backgroundSize:"80% 80%"}}>
        <Container fluid>
          <Row>
